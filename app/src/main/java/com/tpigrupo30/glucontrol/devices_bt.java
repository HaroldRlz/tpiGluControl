...
public class devices_bt extends AppCompatActivity {

    User usuario;
    //1)
    // Depuración de LOGCAT
    private static final String TAG = "devices_bt"; //<-<- PARTE A MODIFICAR >->->
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, usuario.getTipo(),
    ...
    private AdapterView.OnItemClickListener mDeviceClickListener = new AdapterView.OnItemClickListener() {
        public void onItemClick(AdapterView av, View v, int arg2, long arg3) {
            ...
            Intent i = new Intent(devices_bt.this, connection_bt.class);//<-<- PARTE A MODIFICAR >->->
